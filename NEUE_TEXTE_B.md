...
## Befund #85 — zugängliche Namen (anstoss/_widget.html, verwaltung_liste.html, verwaltung_beitraege.html)

- „Ihr Anliegen" → "Your concern"
- „Suchbegriff" → "Search term"
- „Status filtern" → "Filter by status"
- „Bank" → "Bank"
- „Institutions-ID" → "Institution ID"
- „Kontoauszug (camt.053-XML oder CSV)" → "Account statement (camt.053 XML or CSV)"
